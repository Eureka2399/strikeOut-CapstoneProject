import ContattiImage from "../assets/contattimage.jpg";
import { MapContainer, TileLayer, Marker, Popup } from "react-leaflet";
import L from "leaflet"; // Importa Leaflet per un'eventuale personalizzazione
import "leaflet/dist/leaflet.css"; // Importa lo stile di Leaflet
import "../style/contatti.css";

function Contatti() {
  const position = [41.89, 12.492];

  // Personalizzazione del marker
  const customIcon = new L.Icon({
    iconUrl: require("../assets/marker.png"), // Aggiungi un'icona personalizzata
    iconSize: [32, 32],
    iconAnchor: [16, 32],
    popupAnchor: [0, -32],
  });
  ...
  return (
    <div>
      <div className="spazio-contatti">
        <img src={ContattiImage} alt="Contatti" />
        <div className="contatti">
          <p>Strike Out S.r.l.</p>
          <p>Via Chenonesiste 00, 00000, ROMA (RM)</p>
          <p>Recapiti</p>
          ...
          <div className="mail">
            ...
            <a href="mailto:info@strikeout.it">info@strikeout.it</a>
          </div>
